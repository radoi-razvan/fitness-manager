    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GymsGymId = table.Column<long>(type: "bigint", nullable: false),
                    UserId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymUser", x => new { x.GymsGymId, x.UserId });
                    table.ForeignKey(
                        name: "FK_GymUser_Gym_GymsGymId",
                        column: x => x.GymsGymId,
                        principalTable: "Gym",
                        principalColumn: "GymId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GymUser_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
